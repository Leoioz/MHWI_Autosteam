...
namespace AutoSteamApp.Core
{
    public static class Settings
    {
        ...
        public static string SupportedGameVersion = "421470"; //怪猎又更新，这个数字对应第一步

        public static ulong Off_Base = 0x140000000;
        public static ulong Off_SteamworksCombo = 0x4F859F0;//找内存地址

        public static ulong Off_SaveData = 0x5011710;
        public static ulong Off_DiffSlot = 0x26CC00; // 尤其是这个start of each save slot data slotnr * off
        #endregion
